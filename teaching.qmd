---
title: "Teaching"
description-meta: "Teaching by Matt Hester at UA Little Rock — a public course-material portfolio in mathematics and statistics spanning current, undergraduate, and graduate courses, a concepts-first and reproducible approach, the Course Builder course-design harness, and the Math Assistance Center."
toc: false
sidebar: teaching
---
...
This portfolio collects my **public course-material sites** — the courses I
am currently teaching, the assembled undergraduate collection, and the
graduate collection now being built. This page is the overview; the
[Course Library](courses.qmd) is the complete inventory, undergraduate and
graduate together, with search and filtering.
...
## Undergraduate course sites {#undergraduate-course-sites}
...
::: {.course-hero-card}
[![](assets/images/course-motifs/thumbs/intro-probability-hero-480.webp){.course-hero-card-img srcset="assets/images/course-motifs/thumbs/intro-probability-hero-480.webp 480w, assets/images/course-motifs/thumbs/intro-probability-hero.webp 800w" sizes="(min-width: 576px) 585px, 90vw" fig-alt="Course identity hero for Introduction to Probability — an iridescent opal crystal surrounded by probability graphics including sample spaces and events, the probability rules, Bayes' rule, a binomial distribution, the normal curve, expectation, a Monte Carlo simulation sketch, and the law of large numbers, with the course title."}](/intro-probability/)
...
::: {.course-hero-card}
[![](assets/images/course-motifs/thumbs/statistical-inference-hero-480.webp){.course-hero-card-img srcset="assets/images/course-motifs/thumbs/statistical-inference-hero-480.webp 480w, assets/images/course-motifs/thumbs/statistical-inference-hero.webp 800w" sizes="(min-width: 576px) 585px, 90vw" fig-alt="Course identity hero for Statistical Inference — a deep-blue crystal cluster surrounded by inference graphics including the inferential problem, a likelihood curve, a confidence interval, a hypothesis test, a sampling distribution, a Bayesian update, the bootstrap, and a randomization test, with the course title."}](/statistical-inference/)
...
::: {.course-hero-card}
[![](assets/images/course-motifs/thumbs/statistical-modeling-hero-480.webp){.course-hero-card-img srcset="assets/images/course-motifs/thumbs/statistical-modeling-hero-480.webp 480w, assets/images/course-motifs/thumbs/statistical-modeling-hero.webp 800w" sizes="(min-width: 576px) 585px, 90vw" fig-alt="Course identity hero for Statistical Modeling — a crimson crystalline cube cluster surrounded by regression graphics including the linear model equation, a residuals-versus-fitted plot, a normal Q-Q plot, a logistic-regression curve, prediction and RMSE panels, and an AIC model-comparison chart, with the course title."}](/statistical-modeling/)
...
::: {.course-hero-card}
[![](assets/images/course-motifs/thumbs/modern-sas-hero-480.webp){.course-hero-card-img srcset="assets/images/course-motifs/thumbs/modern-sas-hero-480.webp 480w, assets/images/course-motifs/thumbs/modern-sas-hero.webp 800w" sizes="(min-width: 576px) 585px, 90vw" fig-alt="Course identity hero for Modern SAS for Statistical Analytics — a banded green malachite crystal surrounded by SAS analytics-workflow graphics including an import-validate-analyze-report-decide pipeline, a DATA step example, a SAS project folder tree, a PROC MEANS table, and a PROC SGPLOT scatterplot, with the course title."}](/modern-sas/)

::: {.course-hero-card-caption}
[**Modern SAS for Statistical Analytics**](/modern-sas/)
...
::: {.course-hero-card}
[![](assets/images/course-motifs/thumbs/statistical-design-hero-480.webp){.course-hero-card-img srcset="assets/images/course-motifs/thumbs/statistical-design-hero-480.webp 480w, assets/images/course-motifs/thumbs/statistical-design-hero.webp 800w" sizes="(min-width: 576px) 585px, 90vw" fig-alt="Course identity hero for Design, Experiments and Causal Evidence — a tan desert-rose crystal cluster surrounded by study-design graphics including a design-to-evidence workflow, a causal diagram with a confounder and a backdoor path, and a blocking-improves-precision illustration, with the course title."}](/statistical-design/)
...
::: {.course-hero-card}
[![](assets/images/course-motifs/thumbs/applied-statistics-hero-480.webp){.course-hero-card-img srcset="assets/images/course-motifs/thumbs/applied-statistics-hero-480.webp 480w, assets/images/course-motifs/thumbs/applied-statistics-hero.webp 800w" sizes="(min-width: 576px) 585px, 90vw" fig-alt="Course identity hero for Applied Statistical Methods — a pink-and-green watermelon-tourmaline crystal cluster surrounded by applied-statistics graphics including a linear-model equation, group comparisons and ANOVA, a two-way interaction, regression with diagnostics, a contingency table, and a logistic-regression curve, with the course title."}](/applied-statistics/)

::: {.course-hero-card-caption}
[**Applied Statistical Methods**](/applied-statistics/)
...
::: {.course-hero-card}
[![](assets/images/course-motifs/thumbs/nonparametrics-hero-480.webp){.course-hero-card-img srcset="assets/images/course-motifs/thumbs/nonparametrics-hero-480.webp 480w, assets/images/course-motifs/thumbs/nonparametrics-hero.webp 800w" sizes="(min-width: 576px) 585px, 90vw" fig-alt="Course identity hero for Resampling, Nonparametric and Robust Methods — a red-orange vanadinite crystal cluster surrounded by assumption-light graphics including a bootstrap percentile interval, permutation and randomization tests, rank-based methods, robust estimators with a breakdown-point chart, and a method-comparison simulation, with the course title."}](/nonparametrics/)
...
## Graduate courses {#graduate-course-sites}

Graduate records live in the Course Library alongside the undergraduate ones,
rather than in a separate catalog. The graduate portion is early: it covers
the mathematical-statistics sequence and the directions the rest of the
graduate curriculum is heading in, and each record carries the state its
public materials are actually in.

See the [graduate records in the Course
Library](courses.qmd#category=Graduate) for what exists today.

## Course Builder

These public course sites are the current public demonstration layer for
