...
graduate collection now being built — described below.
...
## Graduate course sites {#graduate-course-sites}

The graduate collection is early, and it has its own page so it can grow
without crowding the undergraduate sites above. **Mathematical Statistics I**
(MATH 75063) is the first course being assembled there. It is in development
and does not have a public course site yet.

See the [graduate course sites](teaching-graduate.qmd) for the state of that
collection and where the course sits in the graduate curriculum.
